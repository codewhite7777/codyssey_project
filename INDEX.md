...
| 과제 슬러그 | 번호 | 구분 | 과제명 | 시간 | 상태 | repo | 배포 | 평가 | 보너스 |
|---|---|---|---|---|---|---|---|---|---|
| `web-portfolio` | B1-1 | 웹 기초와 프론트엔드 | 나를 소개하는 웹페이지 처음부터 만들기 | 80h · 필수 | **설계 확정 · 구현 대기** | 생성 대기 | — | — | 미정 |
| | | | *(다음 과제 · React 예정)* | | 미착수 | | | | |
...
```
1. mkdir -p missions/<단계슬러그>/<과제슬러그>/{source,evidence}
2. 과제 원문 → source/assignment.md   (수정 금지)
3. templates/{MISSION_SPEC,NOTE,CHECKLIST}.md → missions/<단계>/<과제>/
...
| 2026-09-17 | B1-1 `web-portfolio` 접수·분석 완료 — R 58개 / C 10개 / E 22개(예측) / V 25개 |
